...
public class LoginView extends CustomComponent implements View
{
    ...
    public LoginView()
    {
        ...
        textFieldUserName.setIcon(FontAwesome.USER);
        ...
        buttonLogin.addClickListener(new ClickListener() {
            ...
            public void buttonClick(ClickEvent event)
            {
                ...
                if (!textFieldUserName.isValid() || !passwordField.isValid())
                {
                    return;
                }
        ...
        OAuthPopupButton oauthLoginButton = new GitHubButton(GITHUB_KEY, GITHUB_SECRET);
    ...
    private GridLayout buildMainLayout()
    {
        ...
        textFieldUserName.setCaption("User name");
        textFieldUserName.setImmediate(false);
        textFieldUserName.setDescription("Enter your user name here");
        textFieldUserName.setWidth("100.0%");
        textFieldUserName.setHeight("-1px");
        textFieldUserName.setTabIndex(1);
        textFieldUserName.setRequired(true);
        textFieldUserName.setInputPrompt("User name");
        textFieldUserName.setNullRepresentation("User name");
        mainLayout.addComponent(textFieldUserName, 1, 1);
