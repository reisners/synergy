...
import test.try14.auth.UserProfile;
...
@VaadinView(navigationTarget=LoginView.NAME, cached=true)
@Component
@Lazy
...
public class LoginView extends CustomComponent implements View
{
    ...
    public LoginView()
    {
        ...
        buttonLogin.addClickListener(new ClickListener() {
            ...
            public void buttonClick(ClickEvent event)
            {
                ...
                String userName = textFieldUserId.getValue();
                String password = passwordField.getValue();
                
                try
                {
                    UserProfile userProfile = authService.loginWithUserIdAndPassword(userName, password);
                    loggedIn(userProfile, null);
                }
                catch (Exception e)
                {
                    log.error("userName="+userName+", password="+password, e);
        ...
        oauthLoginButton.addOAuthListener(new OAuthListener() {
            ...
            public void authSuccessful(String accessToken, String accessTokenSecret)
            {
                ...
                try
                {
                    ...
                    UserProfile userProfile = authService.loginWithGitHub(json, avatarUri);
                    loggedIn(userProfile, avatarUri);
                }
    ...
    protected void loggedIn(UserProfile userProfile, String avatarUri)
    {
        getSession().setAttribute("userProfile", userProfile);
        ...
        Notification.show("Welcome " + userProfile.getRealName());

        // customize navigation hierarchy for user profile
        mainView.setUserProfile(userProfile);
